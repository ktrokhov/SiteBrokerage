...
allBrkNames = ['ВТБ Капитал Брокер', 'Тинькофф Банк', 'ПАО Сбербанк', 'Инвестиционный Банк "ФИНАМ"',
             'ООО "АТОН"', 'Компания "Брокеркредитсервис"', 'Банк "Финансовая Корпорация Открытие"', 'АО "АЛЬФА-БАНК"',
             ...
             'ООО "УРАЛСИБ Брокер"','ООО Инвестиционная компания "Септем Капитал"' 'АО Инвестиционно - финансовая компания "Солид"',
             'ПАО Акционерный коммерческий банк "АК БАРС"', 'АО Инвестиционная компания "РИКОМ-ТРАСТ"', 'ООО Инвестиционная Компания «КьюБиЭф»',
